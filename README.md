...
4. Iniciar el Frontend de la página web desde la línea de comandos con el comando: ```npm run dev```
5. Abrir la página web desde la dirección: https://localhost:3000/